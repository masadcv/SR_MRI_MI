...
# ============================================================================
# From: https://github.com/Lornatang/VDSR-PyTorch/blob/master/model.py
# Modifications:
# Added upsampling layer to the model
...
class VDSR(nn.Module):
    def __init__(self, scale=2) -> None:
        ...
        self.upsample = nn.Upsample(scale_factor=scale, mode="bicubic", align_corners=True)
